    ...
    <main className="min-h-screen text-slate-900 bg-transparent">
      <section className="mx-auto max-w-6xl px-6 py-14">
        <header className="mb-16">
          <h1 className="font-serif text-5xl md:text-6xl font-bold text-slate-900 italic tracking-tighter">Store.</h1>
          <p className="mt-4 text-xl text-slate-500 max-w-2xl font-serif italic leading-relaxed">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {products.map((p) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="font-serif text-xl font-bold text-slate-900 italic group-hover:text-blue-600 transition-colors">
                  {p.title}
                </h3>
              </div>
            </Link>
