          ...
          <div className="mx-auto max-w-6xl px-6 py-20 grid gap-12 md:grid-cols-2 md:items-center">
            <div>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <NextLink
                  href="/boutique"
                  className="rounded-md bg-accent px-6 py-3 text-white text-base font-medium transition transform-gpu hover:-translate-y-1 hover:scale-[1.02] hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                >
                  Browse guides
                </NextLink>
                <NextLink
        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            ...
            <NextLink
              ...
              className="group block rounded-xl border overflow-hidden transition hover:-translate-y-1 hover:shadow-xl hover:border-accent transform-gpu"
            >
