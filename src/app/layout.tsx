        ...
        <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6 py-3 flex items-center justify-between">
            ...
            <nav aria-label="Main navigation" className="flex items-center gap-0.5 md:gap-2">
              ...
              <Link
                href="/app"
                className="ml-1 px-4 py-1.5 rounded-full bg-blue-600 text-white text-[13px] md:text-sm font-semibold hover:bg-blue-700 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 whitespace-nowrap shadow-sm"
              >
                The App
              </Link>
            </nav>
